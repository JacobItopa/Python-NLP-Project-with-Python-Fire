[![Python application test with Github Actions](https://github.com/JacobItopa/Python-NLP-Project-with-Python-Fire/actions/workflows/main.yml/badge.svg)](https://github.com/JacobItopa/Python-NLP-Project-with-Python-Fire/actions/workflows/main.yml)
